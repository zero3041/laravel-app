    ...
    <div class="content-wrapper">
        ...
        <div class="content">
            <div class="container-fluid">
                <div class="row">
                    <form method='POST' action="{{ route('roles.update',['id'=>$role->id]) }}" style="width: 100%">
                        <div class="col-lg-12">
                            @csrf
                                            ...
                                            <div class="row bg-secondary">
                                                @foreach($permissionsParentItem->permissionsChildrent as $permissionsChildrenItem)
                                                    <div class="card-body col-md-3">
                                                        <h5 class="card-title">
                                                            <label>
                                                                <input  {{ $permissionsCheck->contains('id',$permissionsChildrenItem->id) ? 'checked' : '' }}
                                                                        name="permission_id[]"
                                                                        class="checkbox_children"
                                                                        type="checkbox" value="{{ $permissionsChildrenItem->id }}">
                                                            </label>
